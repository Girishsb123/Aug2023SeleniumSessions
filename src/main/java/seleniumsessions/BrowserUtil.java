...
import seleniumpractice.AutomationException;

/**
 * 
 * @author naveenautomationlabs BrowserUtil is having multiple generic methods
 *         to handle the various browser actions
 *
 */
